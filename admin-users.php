...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      $sql = "SELECT * FROM workorder WHERE dataStatusId IS NULL ORDER BY orderDate desc";
                  ...
                  <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                        ...
                        <td>
                          <?php $tid = $row['userID'];
                          $qr = mysqli_query($conn, "SELECT * FROM users WHERE user_id = '$tid'");
                          mysqli_num_rows($qr);
                        ...
                        <td class="project-actions text-right">
                          <button>
                            ...
                            <?php
                            if ($row['money_order'] > 2 ) {
                              ?>
                              <p class="status">Санал илгээсэн</p>
                              <?php
                            } elseif ($row['money_order'] == 1  ) {
                              ?>
                              <p class="status2">Батлах боломжгүй</p>
                              <?php
                            } else {
                              ?>
                              <p>Батлаагүй</p>
                        ...
                        <td class="project-actions text-right">
                          <?php if ($row['orderStatus'] > 0) {
                            ?>
                            <p class="status">Санхүү баталсан</p>
                            <?php
                          } else {
                            ?>
